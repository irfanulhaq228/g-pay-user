// Crypto not add code of main page below
...
// add crypto in this main one file code below
...
//                         <span className="font-[500]">Crypto Wallet ID :</span> {selectedBank?.iban}
//                         {!copyWallet ? (
//                           <FaRegCopy
//                             className="inline-block mt-[-2px] ms-[15px] cursor-pointer"
//                             onClick={() => fn_copy("copyWallet", selectedBank?.iban)}
//                           />
//                         ) : (
//                           <TiTick className="inline-block mt-[-2px] ms-[15px] scale-[1.2] cursor-pointer" />
//                         )}
...
//                 </div>
//               )}
//               <div className={`flex items-center ${bank?.image ? "my-[18px]" : "-mt-[17px] mb-[16px]"}`}>
//                 <img
//                   src={attention}
//                   alt="Attention Sign"
